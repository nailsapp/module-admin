                    ...
                    foreach ($events as $event) {
                        ...
                        if ($event->data) {
                            ...
                            echo '<td class="actions">';
                                echo '<a href="#data-' . $event->id . '" class="btn btn-xs btn-primary fancybox">View Data</a>';
                                echo '<div id="data-' . $event->id . '" style="display:none;">';
                                    echo '<p class="alert alert-warning"><strong>Note:</strong> This is raw, unformatted data associated with the event.<br />The system uses this information to specify specific items relating to this particular event.</p>';
